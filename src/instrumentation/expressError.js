...
function patch (express, tracers) {
  ...
  shimmer.wrap(express.Router, 'use', (originalUse) => function errorHandler (...args) {
    ...
    shimmer.wrap(lastLayer, 'handle_error', (originalHandleError) => function (err, req, res, next) {
